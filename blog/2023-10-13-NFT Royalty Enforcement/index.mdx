...
我們將 [Ethereum 的 NFT Fractionalization](https://www.leewayhertz.com/fractional-nft/) 改造成適合 TON 的方法，並且將其應用在 NFT Enforced Royalty 上。
...
4. 這些 **NFT Fraction** 未來再轉移給其他人時，也會扣除一定比例的版稅。
