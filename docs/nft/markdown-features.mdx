...
- `NFTAddress`: The address of the NFT being auctioned.
...
## Bidders can perform the following actions using the Auction contract:
...
### After the Auction Market successfully establishes a dedicated NFT Auction Contract
...
### NFT Auction Market Contract Internal Functions and Get Methods
Internal Function:
``` ts
...
### NFT Auction Contract Internal Functions and Get Methods
Internal Function:
```ts
